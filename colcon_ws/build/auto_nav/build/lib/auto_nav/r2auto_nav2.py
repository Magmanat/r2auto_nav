...
class AutoNav(Node):
    ...
    def occ_callback(self, msg):
        ...
        #   self.mazelayout[int(np.rint(((i[1] - msg.info.origin.position.y)/self.resolution)))][int(np.rint(((i[0] - msg.info.origin.position.x)/self.resolution)))] = 3
    ...
    def is_visited(self, direction):
      ...
      if direction == 'right':
        for i in square:
          print(self.visitedarray[self.XposNoAdjust + i[0]][self.YposNoAdjust - 3 + i[1]])
          if self.visitedarray[self.XposNoAdjust + i[0]][self.YposNoAdjust - 3 + i[1]] == 1:
            print("right visited")
            return True
      elif direction == 'up':
        for i in square:
          print(self.visitedarray[self.XposNoAdjust + 3 + i[0]][self.YposNoAdjust + i[1]] == 1)
          if self.visitedarray[self.XposNoAdjust + 3 + i[0]][self.YposNoAdjust + i[1]] == 1:
            print("up visited")
            return True
      elif direction == 'left':
        for i in square:
          print(self.visitedarray[self.XposNoAdjust + i[0]][self.YposNoAdjust + 3 + i[1]] == 1)
          if self.visitedarray[self.XposNoAdjust + i[0]][self.YposNoAdjust + 3 + i[1]] == 1:
            print("left visited")
            return True
      elif direction == 'down':
    ...
    def recursive_maze(self):
        ...
        for i in directions:
            # print("in directions")
            if (not self.is_visited(i[0])) and (self.is_empty(i[0])):
                # print("in recursive maze")
                self.move(i[0])
                solved = self.recursive_maze()
                if solved:
                    return True
                for b in range(100):
                    rclpy.spin_once(self)
